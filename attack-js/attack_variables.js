...
const mash = attack.module.mash;
const charge = attack.module.charge;
const stone_armor = attack.module.stone_armor;
const block = attack.module.block;
const fire_arrow = attack.module.fire_arrow;
const stab = attack.module.stab;
const attack_elixir = attack.module.attack_elixir;
